...
use App\Services\MyPageService as ServicesMyPageService;
use Carbon\Carbon;
...
class MyPageController extends Controller
{
    public function index()
    {
        ...
        $events = $user->events;
        $fromTodayEvents = ServicesMyPageService::reservedEvent($events, 'fromToday');
        $pastEvents = ServicesMyPageService::reservedEvent($events, 'past');
